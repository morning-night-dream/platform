...
import (
	...
	"github.com/morning-night-dream/platform/app/db/ent/migrate"

	"github.com/morning-night-dream/platform/app/db/ent/article"
	"github.com/morning-night-dream/platform/app/db/ent/articletag"
	"github.com/morning-night-dream/platform/app/db/ent/auth"
	"github.com/morning-night-dream/platform/app/db/ent/readarticle"
...
func (c *ArticleClient) QueryReadArticles(a *Article) *ReadArticleQuery {
	query := &ReadArticleQuery{config: c.config}
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := a.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(article.Table, article.FieldID, id),
